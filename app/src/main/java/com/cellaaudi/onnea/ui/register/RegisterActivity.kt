...
//        context = this
        ...
        binding?.btnReg?.setOnClickListener {
            ...
            val email = binding?.txtRegEmail?.editText?.text.toString()
            val pass = binding?.txtRegPass?.editText?.text.toString()

            if (pass == binding?.txtRegPass2?.editText?.text.toString() && pass.length > 5) {
                ...
                Toast.makeText(this, getString(R.string.pass_diff), Toast.LENGTH_SHORT).show()
            }
        }
    }
